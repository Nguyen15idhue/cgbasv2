...
console.info('Server is running at http://127.0.0.1:3001/')
console.info('Login URL: http://127.0.0.1:3001/login, automatically open browser in three seconds')

setTimeout(async () => {
  await open("http://127.0.0.1:3001/login")
}, 3000)